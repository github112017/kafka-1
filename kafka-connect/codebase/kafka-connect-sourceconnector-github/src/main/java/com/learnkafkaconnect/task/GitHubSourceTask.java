...
import com.learnkafkaconnect.apiclient.GitHubAPIHttpClient;
import com.learnkafkaconnect.config.GitHubSourceConnectorConfig;
import com.learnkafkaconnect.util.DateUtils;
import com.learnkafkaconnect.util.VersionUtil;
...
import com.learnkafkaconnect.model.*;

import java.time.Instant;
import java.util.*;

import static com.learnkafkaconnect.schemas.GitHubSchemas.*;
...
public class GitHubSourceTask extends SourceTask {
    ...
    private void initializeLastVariables(){
        ...
        log.info("lastSourceOffset : " + lastSourceOffset);
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        log.info("Poll is invoked");
        Map<String, Object> lastSourceOffset = null;
        lastSourceOffset = context.offsetStorageReader().offset(sourcePartition());
        log.info("lastSourceOffset in poll : " + lastSourceOffset);
        // fetch data
