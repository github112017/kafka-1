...
import com.learnkafkaconnect.validators.BatchSizeValidator;
import com.learnkafkaconnect.validators.TimestampValidator;
...
public class GitHubSourceConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef conf() {
        return new ConfigDef()
                ...
                .define(BATCH_SIZE_CONFIG, Type.INT, 2, new BatchSizeValidator(), Importance.LOW, BATCH_SIZE_DOC)
